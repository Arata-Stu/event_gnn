...
class DSECDet:
    def __init__(self, root: Path, split: str="train", sync: str="front", debug: bool=False, split_config: DictConfig=None):
        """
        ...
        if split_config is None:
            ...
            sequence_names = split_config[split]
            available_dirs = list(self.root.glob("*/"))
            self.subsequence_directories = [self.root / s for s in sequence_names if self.root / s in available_dirs]
